...
<div class="container">
    ...
    <h1 style="text-align: center;"><a id="convierteteenorador">ANILLOS</a></h1>
    <div class="row row-cols-1 row-cols-md-3 g-4" style="margin-top: 4%;">
        <div class="col">
            <div class="card h-100">
                <img src="img/anillo1.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title" style="margin-top: 1%;">Anillo 1</h5>
                    <p class="card-text"></p>
        ...
        <div class="col">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title" style="margin-top: 1%;">Anillo 2</h5>
                    <p class="card-text"></p>
                    <a type="button" class="btn btn-success" href="login.jsp">Comprar</a>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card h-100">
                <img src="img/anillo3.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title" style="margin-top: 1%;">Anillo 3</h5>
                    <p class="card-text"></p>
                    <a type="button" class="btn btn-success" href="login.jsp">Comprar</a>
            </div>
        </div>
